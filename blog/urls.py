from . import views
from .views import PostListView,PostDetailView,PostCreateView,PostUpdateView,PostDeleteView,UserPostListView,DatabaseView,upload_xls
...
urlpatterns = [
    ...
    path('import-xls/',upload_xls,name='import-xls')
]
